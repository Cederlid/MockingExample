...
class EmployeeManagerTest {
    ...
    private BankServiceSpy bankServiceSpy = mock(BankServiceSpy.class);
    ...
    private final EmployeeManager employeeManager = new EmployeeManager(employeeRepositoryStub, bankServiceSpy);
    ...
    void testPayEmployeesShouldBeCalledOneTime() {
        bankServiceSpy.pay("1", 100);
        verify(bankServiceSpy, Mockito.times(1)).pay("1", 100);
    }
